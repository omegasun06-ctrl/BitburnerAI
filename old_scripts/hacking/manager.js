import { getThreadPool } from "/scripts/hacking/worker";
import { HackableServer, HackPlanner } from "/scripts/hacking/planner";
import { renderBatches, logHTML } from "/scripts/hacking/batch-view";
...
flags.getMaxTotalRam
    flags.getmaxTotalRam() ||= backend.getMaxTotalRam();
